// PR Sprint D-4 — create heygen_lipsync_jobs table.
//
// Run with: `npx tsx scripts/migrate-heygen-lipsync.ts`
...
async function main() {
  ...
  console.log('[migrate] Creating heygen_lipsync_jobs…');
